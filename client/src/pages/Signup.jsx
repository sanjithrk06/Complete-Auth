              ...
              <div className="flex flex-col overflow-hidden rounded-lg bg-white shadow-sm">
                <div className="grow p-4 md:px-8 md:py-6">
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <h1 className="pb-2 text-center text-2xl text-primary font-bold">
                      Create Your Account
                    </h1>
                    ...
                    <div className=" flex flex-col md:flex-row gap-4">
                      ...
                      <div className=" w-full md:w-1/2 space-y-1">
                        ...
                        <input
                          ...
                          className="block w-full rounded-lg outline-none border px-4 py-2 leading-6 text-slate-700 placeholder-gray-400 focus:ring-2 focus:ring-primary/50 border-gray-200 focus:border-primary"
                        />
                      </div>
